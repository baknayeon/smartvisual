...
preferences {
	section {
		input "weatherDevices", "attribute.smartweatherStationTile"
	}
}
...
def scheduledEvent() {
	log.info "SmartWeather Station Controller / scheduledEvent terminated due to deprecation" // attribute handles this itself now -- Bob
/*
